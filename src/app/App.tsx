...
export default function App() {
  ...
  const handleExportPDF = async () => {
    ...
    setExporting(true);
    try {
      const url = `https://docs.google.com/spreadsheets/d/${spreadsheetId}/export?format=pdf&size=A4&portrait=true&scale=1&fitw=false&gridlines=false&printtitle=false&sheetnames=false&top_margin=0.5&bottom_margin=0.5&left_margin=0.7&right_margin=0.2&hc=true`;
